...
public class ProcessesTestCase extends TestBase {
    ...
    @Nonnull private OWLObjectProperty topObject = df.getOWLTopObjectProperty();
    @Nonnull private OWLClass composition = df.getOWLClass(IRI.create("urn:mereology#Composition"));
    @Nonnull private OWLClass abstractEntity = df.getOWLClass(IRI.create("urn:mereology#Abstract_Entity"));
    @Nonnull private OWLClass whole = df.getOWLClass(IRI.create("urn:mereology#Whole"));
    @Nonnull private OWLClass pair = df.getOWLClass(IRI.create("urn:mereology#Pair"));
    @Nonnull private OWLClass part = df.getOWLClass(IRI.create("urn:mereology#Part"));
    @Nonnull private OWLClass serviceModel = df.getOWLClass(IRI.create("urn:Service#ServiceModel"));
    @Nonnull private OWLClass compositeProcess = df.getOWLClass(IRI.create("urn:Process#CompositeProcess"));
    @Nonnull private OWLObjectProperty composedOf = df.getOWLObjectProperty(IRI.create("urn:Process#composedOf"));
    @Nonnull private OWLClass simpleProcess = df.getOWLClass(IRI.create("urn:Process#SimpleProcess"));
    @Nonnull private OWLClass atomicProcess = df.getOWLClass(IRI.create("urn:Process#AtomicProcess"));
    @Nonnull private OWLClass process = df.getOWLClass(IRI.create("urn:Process#Process"));
    @Nonnull private String input1 = "Prefix(owl:=<http://www.w3.org/2002/07/owl#>)\n"
