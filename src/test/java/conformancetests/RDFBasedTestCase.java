...
class RDFBasedTestCase extends TestBase {

    @Test
    @ChangedTestCase
    void testrdfbased_sem_bool_complement_inst() {
        premise =
        ...
        test("rdfbased_sem_bool_complement_inst", TestClasses.INCONSISTENCY,
            "An individual cannot be an instance of both a class and its complement.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_bool_intersection_inst_expr() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_bool_intersection_inst_expr", TestClasses.POSITIVE_IMPL,
            "An individual, which is an instance of an intersection class expression of two classes, is an instance of every component class.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_chain_def() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_chain_def", TestClasses.POSITIVE_IMPL,
            "For a sub property chain axiom with super property p and chain properties p1 and p2, from x p1 y and y p2 z follows x p z.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_char_asymmetric_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
                ...
                + "</rdf:RDF>";
        test("rdfbased_sem_char_asymmetric_inst", TestClasses.INCONSISTENCY,
            "For a triple having an asymmetrical property as its predicate, the reverse triple must not exist.");
    }

    @Test
    void testrdfbased_sem_char_asymmetric_term() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_char_asymmetric_term", TestClasses.INCONSISTENCY,
            "A non-empty property cannot be both symmetrical and asymmetrical.");
    }

    @Test
    void testrdfbased_sem_char_inversefunc_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_char_inversefunc_inst", TestClasses.POSITIVE_IMPL,
    ...
    @Test
    @ChangedTestCase
    void testrdfbased_sem_char_irreflexive_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
        ...
        test("rdfbased_sem_char_irreflexive_inst", TestClasses.INCONSISTENCY,
            "For an irreflexive property, there must not exist any reflexive triple.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_char_symmetric_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
                + "  <owl:SymmetricProperty rdf:about=\"http://www.example.org#p\"/>\n"
        ...
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "  <rdf:Description rdf:about=\"http://www.example.org#y\">\n"
                + "    <ex:p rdf:resource=\"http://www.example.org#x\"/></rdf:Description></rdf:RDF>";
        test("rdfbased_sem_char_symmetric_inst", TestClasses.POSITIVE_IMPL,
            "For a triple having a symmetrical property as its predicate, the reverse triple also exists.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_char_transitive_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
        ...
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "  <rdf:Description rdf:about=\"http://www.example.org#x\">\n"
                + "    <ex:p rdf:resource=\"http://www.example.org#z\"/></rdf:Description></rdf:RDF>";
        test("rdfbased_sem_char_transitive_inst", TestClasses.POSITIVE_IMPL,
            "For two chained triples having the same transitive property as their predicate, the transitive result triple also exists.");
    }

    @Test
    void testrdfbased_sem_class_nothing_ext() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:Nothing rdf:about=\"http://www.example.org#x\"/></rdf:RDF>";
        test("rdfbased_sem_class_nothing_ext", TestClasses.INCONSISTENCY,
            "The extension of the vocabulary class owl:Nothing is empty.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_class_nothing_term() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_class_nothing_term", TestClasses.POSITIVE_IMPL,
            "Every OWL class is a super class of the vocabulary class owl:Nothing.");
    }

    @Test
    void testrdfbased_sem_class_nothing_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:Class rdf:about=\"http://www.w3.org/2002/07/owl#Nothing\"/></rdf:RDF>";
        test("rdfbased_sem_class_nothing_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary class owl:Nothing is the class of OWL classes.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_class_thing_term() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:Class rdf:about=\"http://www.example.org#c\"/></rdf:RDF>";
        conclusion =
        ...
        test("rdfbased_sem_class_thing_term", TestClasses.POSITIVE_IMPL,
            "Every OWL class is a sub class of the vocabulary class owl:Thing.");
    }

    @Test
    void testrdfbased_sem_class_thing_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:Class rdf:about=\"http://www.w3.org/2002/07/owl#Thing\"/></rdf:RDF>";
        test("rdfbased_sem_class_thing_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary class owl:Thing is the class of OWL classes.");
    }

    @Test
    void testrdfbased_sem_eqdis_different_sameas() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#x\">\n"
        ...
        test("rdfbased_sem_eqdis_different_sameas", TestClasses.INCONSISTENCY,
            "Two individuals cannot both be the same and different.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_disclass_eqclass() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
                + "  <owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
        ...
        test("rdfbased_sem_eqdis_disclass_eqclass", TestClasses.INCONSISTENCY,
            "Two non-empty classes cannot both be equivalent and disjoint.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_disclass_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
                ...
                + "  <rdf:Description rdf:about=\"http://www.example.org#c1\">\n"
                + "    <owl:disjointWith rdf:resource=\"http://www.example.org#c2\"/></rdf:Description></rdf:RDF>";
        test("rdfbased_sem_eqdis_disclass_inst", TestClasses.INCONSISTENCY,
            "Individuals being instances of disjoint classes are different from each other.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqclass_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
    ...
    void testrdfbased_sem_eqdis_eqclass_rflxv() {
        ...
        test("rdfbased_sem_eqdis_eqclass_rflxv", TestClasses.POSITIVE_IMPL,
            "Equivalence of two classes is reflexive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqclass_subclass_2() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "  <rdf:Description rdf:about=\"http://www.example.org#c1\">\n"
                + "    <owl:equivalentClass rdf:resource=\"http://www.example.org#c2\"/></rdf:Description></rdf:RDF>";
        test("rdfbased_sem_eqdis_eqclass_subclass_2", TestClasses.POSITIVE_IMPL,
            "Two classes that are sub classes of each other are equivalent classes.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqclass_subst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_eqdis_eqclass_subst", TestClasses.POSITIVE_IMPL,
            "Equivalence of two classes allows for substituting one class for the other in a sub class axiom.");
    }

    @Test
    void testrdfbased_sem_eqdis_eqclass_sym() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#c1\">\n"
                + "    <owl:equivalentClass rdf:resource=\"http://www.example.org#c2\"/></rdf:Description></rdf:RDF>";
        ...
        test("rdfbased_sem_eqdis_eqclass_sym", TestClasses.POSITIVE_IMPL,
            "Equivalence of two classes is symmetrical.");
    }

    @Test
    void testrdfbased_sem_eqdis_eqclass_trans() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#c1\">\n"
                + "    <owl:equivalentClass>\n"
        ...
        test("rdfbased_sem_eqdis_eqclass_trans", TestClasses.POSITIVE_IMPL,
            "Equivalence of two classes is transitive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqprop_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_eqdis_eqprop_inst", TestClasses.POSITIVE_IMPL,
            "For two equivalent properties and any triple having one property as its predicate, the corresponding triple having the other property as its predicate also exists, and vice versa.");
    }

    @Test
    void testrdfbased_sem_eqdis_eqprop_rflxv() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
        ...
        test("rdfbased_sem_eqdis_eqprop_rflxv", TestClasses.POSITIVE_IMPL,
            "Equivalence of two properties is reflexive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqprop_subprop_1() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "</rdf:RDF>";
        test("rdfbased_sem_eqdis_eqprop_subprop_1", TestClasses.POSITIVE_IMPL,
            "Two equivalent properties are sub properties of each other.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqprop_subprop_2() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "  <rdf:Description rdf:about=\"http://www.example.org#p1\">\n"
                + "    <owl:equivalentProperty rdf:resource=\"http://www.example.org#p2\"/></rdf:Description></rdf:RDF>";
        test("rdfbased_sem_eqdis_eqprop_subprop_2", TestClasses.POSITIVE_IMPL,
            "Two properties that are sub properties of each other are equivalent properties.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_eqprop_subst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_eqdis_eqprop_subst", TestClasses.POSITIVE_IMPL,
            "Equivalence of two properties allows for substituting one property for the other in a sub property axiom.");
    }

    @Test
    void testrdfbased_sem_eqdis_eqprop_sym() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#p1\">\n"
                + "    <owl:equivalentProperty rdf:resource=\"http://www.example.org#p2\"/></rdf:Description></rdf:RDF>";
        ...
        test("rdfbased_sem_eqdis_eqprop_sym", TestClasses.POSITIVE_IMPL,
            "Equivalence of two properties is symmetrical.");
    }

    @Test
    void testrdfbased_sem_eqdis_eqprop_trans() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#p1\">\n"
        ...
        test("rdfbased_sem_eqdis_eqprop_trans", TestClasses.POSITIVE_IMPL,
            "Equivalence of two properties is transitive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_eqdis_sameas_rflxv() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
        ...
        test("rdfbased_sem_eqdis_sameas_rflxv", TestClasses.POSITIVE_IMPL,
            "Equality of two individuals is reflexive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_inv_inst() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>\n"
        ...
        test("rdfbased_sem_inv_inst", TestClasses.POSITIVE_IMPL,
            "The subject and object of a triple are reversed by an inverse property.");
    }

    @Test
    void testrdfbased_sem_ndis_alldifferent_fw() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                ...
                + "</rdf:RDF>";
        test("rdfbased_sem_ndis_alldifferent_fw", TestClasses.INCONSISTENCY,
            "All the members of an owl:AllDifferent construct are mutually different individuals.");
    }

    @Test
    void testrdfbased_sem_ndis_alldifferent_fw_distinctmembers() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AllDifferent rdf:about=\"http://www.example.org#z\">\n"
                ...
                + "</rdf:RDF>";
        test("rdfbased_sem_ndis_alldifferent_fw_distinctmembers", TestClasses.INCONSISTENCY,
            "All the members of an owl:AllDifferent construct are mutually different from each other. This test applies the legacy property owl:distinctMembers.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_ndis_alldisjointclasses_fw() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_ndis_alldisjointclasses_fw", TestClasses.INCONSISTENCY,
            "All the members of an owl:AllDisjointClasses construct are mutually disjoint classes.");
    }

    @Test
    void testrdfbased_sem_prop_backwardcompatiblewith_type_annot() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2002/07/owl#backwardCompatibleWith\"/></rdf:RDF>";
        test("rdfbased_sem_prop_backwardcompatiblewith_type_annot", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property owl:backwardCompatibleWith is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_comment_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2000/01/rdf-schema#comment\"/></rdf:RDF>";
        test("rdfbased_sem_prop_comment_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property rdfs:comment is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_deprecated_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2002/07/owl#deprecated\"/></rdf:RDF>";
        test("rdfbased_sem_prop_deprecated_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property owl:deprecated is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_incompatiblewith_type_annot() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2002/07/owl#incompatibleWith\"/></rdf:RDF>";
        test("rdfbased_sem_prop_incompatiblewith_type_annot", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property owl:incompatibleWith is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_isdefinedby_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2000/01/rdf-schema#isDefinedBy\"/></rdf:RDF>";
        test("rdfbased_sem_prop_isdefinedby_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property rdfs:isDefinedBy is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_label_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2000/01/rdf-schema#label\"/></rdf:RDF>";
        test("rdfbased_sem_prop_label_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property rdfs:label is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_priorversion_type_annot() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2002/07/owl#priorVersion\"/></rdf:RDF>";
        test("rdfbased_sem_prop_priorversion_type_annot", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property owl:priorVersion is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_seealso_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2000/01/rdf-schema#seeAlso\"/></rdf:RDF>";
        test("rdfbased_sem_prop_seealso_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property rdfs:seeAlso is the class of annotation properties.");
    }

    @Test
    void testrdfbased_sem_prop_versioninfo_type() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"></rdf:RDF>";
        conclusion =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "  <owl:AnnotationProperty rdf:about=\"http://www.w3.org/2002/07/owl#versionInfo\"/></rdf:RDF>";
        test("rdfbased_sem_prop_versioninfo_type", TestClasses.POSITIVE_IMPL,
            "The type of the vocabulary property owl:versionInfo is the class of annotation properties.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfs_subclass_cond() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_rdfs_subclass_cond", TestClasses.POSITIVE_IMPL,
            "The extensions of two classes related by rdfs:subClassOf are in a subsumption relationship.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfs_subclass_trans() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_rdfs_subclass_trans", TestClasses.POSITIVE_IMPL,
            "The property rdfs:subClassOf is transitive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfs_subprop_cond() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_rdfs_subprop_cond", TestClasses.POSITIVE_IMPL,
            "The extensions of two properties related by rdfs:subPropertyOf are in a subsumption relationship.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfs_subprop_trans() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_rdfs_subprop_trans", TestClasses.POSITIVE_IMPL,
            "The property rdfs:subPropertyOf is transitive.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfsext_domain_subprop() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_rdfsext_domain_subprop", TestClasses.POSITIVE_IMPL,
            "Every sub property of a given property with a given domain also has this domain.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfsext_domain_superclass() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_rdfsext_domain_superclass", TestClasses.POSITIVE_IMPL,
            "Every super class of a domain for a given property is itself a domain for that property.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfsext_range_subprop() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p1\"/>\n"
                + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p2\"/>\n"
        ...
        test("rdfbased_sem_rdfsext_range_subprop", TestClasses.POSITIVE_IMPL,
            "Every sub property of a given property with a given range also has this range.");
    }

    @Test
    @ChangedTestCase
    void testrdfbased_sem_rdfsext_range_superclass() {
        premise =
            "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:owl=\"http://www.w3.org/2002/07/owl#\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\" xmlns:ex=\"http://www.example.org#\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\">\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c2\"/>\n"
                + "<owl:Class rdf:about=\"http://www.example.org#c1\"/>\n"
        ...
        test("rdfbased_sem_rdfsext_range_superclass", TestClasses.POSITIVE_IMPL,
