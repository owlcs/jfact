...
class VerifyComplianceOWLSNewFeaturesTestCase extends VerifyComplianceBase {
    ...
    protected OWLOntology load(String input) throws OWLOntologyCreationException {
        OWLOntology onto = m.loadOntologyFromOntologyDocument(new StringDocumentSource(in));
        return onto;
    }
    ...
    void shouldPassgetObjectPropertyRangesisPresentedByfalse() {
        ...
        equal(reasoner.getObjectPropertyRanges(isPresentedBy, false), Thing, Service);
    }
    ...
    void shouldPassgetDataPropertyValuesSWRLrefURI() {
        ...
        assertEquals(reasoner.getDataPropertyValues(SWRL, refURI),
            new HashSet<>(Arrays.asList(df.getOWLLiteral("http://www.w3.org/2003/11/swrl"))));
    }
