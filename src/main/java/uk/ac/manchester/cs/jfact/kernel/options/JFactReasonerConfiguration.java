...
public class JFactReasonerConfiguration implements OWLReasonerConfiguration, Serializable {
    ...
    /**
     * Option 'absorptionFlags' sets up absorption process for general axioms. It text field of
     * arbitrary length; every symbol means the absorption action: (B)ottom Absorption), (T)op
     * absorption, (E)quivalent concepts replacement, (C)oncept absorption, (N)egated concept
     * absorption, (F)orall expression replacement, (R)ole absorption, (S)plit, Simple (f)orall
    ...
    /**
     * Option 'orSortSub' define the sorting order of OR vertices in the DAG used in subsumption
     * tests. Option has form of string 'Mop', where 'M' is a sort field (could be 'D' for depth,
     * 'S' for size, 'F' for frequency, and '0' for no sorting), 'o' is a order field (could be 'a'
     * for ascending and 'd' for descending mode), and 'p' is a preference field (could be 'p' for
     * preferencing non-generating rules and 'n' for not doing so).
     */
    private static StringOption orSortSub = getOption(OR_SORT_SUB, "0");
    /**
     * Option 'orSortSat' define the sorting order of OR vertices in the DAG used in satisfiability
     * tests (used mostly in caching). Option has form of string 'Mop', see orSortSub for details.
     */
    private static StringOption orSortSat = getOption(OR_SORT_SAT, "0");
    /**
     * Option 'IAOEFLG' define the priorities of different operations in to do list. Possible values
     * are 7-digit strings with ony possible digit are 0-6. The digits on the places 1, 2, ..., 7
     * are for priority of Id, And, Or, Exists, Forall, LE and GE operations respectively. The
     * smaller number means the higher priority. All other constructions (TOP, BOTTOM, etc) has
     * priority 0.
     */
    private static final StringOption IAOEFLG = getOption("IAOEFLG", "1263005");
    /**
     * Option 'useSemanticBranching' switch semantic branching on and off. The usage of semantic
     * branching usually leads to faster reasoning, but sometime could give small overhead.
     */
    @PortedFrom(file = "dlTBox.h", name = "useSemanticBranching")
    private boolean useSemanticBranching = true;
    /**
     * Option 'useBackjumping' switch backjumping on and off. The usage of backjumping usually leads
     * to much faster reasoning.
     */
    ...
    /**
     * Option 'useCompletelyDefined' leads to simpler Taxonomy creation if TBox contains no
     * non-primitive concepts. Unfortunately, it is quite rare case.
     */
    private boolean useCompletelyDefined = true;
    /**
     * Option 'useSpecialDomains' (development) controls the special processing of R and D for
     * non-simple roles. Should always be set to true.
     */
    @PortedFrom(file = "dlTBox.h", name = "useSpecialDomains")
    private boolean useSpecialDomains = true;
    /**
     * Option 'useIncrementalReasoning' (development) allows one to reason efficiently about small
     ...
     * 
     * @param useSortedReasoning the new use sorted reasoning
    ...
    /**
     * @param b value for allow undefined entities
     * @return modified instance
     */
    ...
    /**
     * @param b value for query answering
     * @return modified instance
     */
     ...
     * 
     * @param b the new use special domains
     * @return modified instance
     */
     ...
     * 
     * @param b the new use lazy blocking
     * @return modified instance
     */
     ...
     * 
     * @param b the new use anywhere blocking
     * @return modified instance
     */
     ...
     * 
     * @param b the new use semantic branching
     * @return modified instance
     */
     ...
     * 
     * @param val the new use node cache
     * @return modified instance
     */
     ...
     * 
     * @param defSat the new or sort sat
     * @return modified instance
     */
     ...
     * 
     * @param defSat the new or sort sub
     * @return modified instance
     */
     ...
     * Sets the dump query.
     * 
     * @param value the new dump query
     * @return modified instance
     */
     ...
     * 
     * @param b the new verbose output
     * @return modified instance
     */
     ...
     * 
     * @param b the new logging active
     * @return modified instance
     */
     ...
     * 
     * @param b the new absorption logging active
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg improve save restore depset
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg print dag usage
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg use simple rules
     * @return modified instance
     */
     ...
     * 
     * @param b the new use reasoning statistics
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg update rnd from superroles
     * @return modified instance
     */
     ...
     * 
     * @param b the new use blocking statistics
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg use dynamic backjumping
     * @return modified instance
     */
     ...
     * 
     * @param b the new tmp print taxonomy info
     * @return modified instance
     */
     ...
     * 
     * @param b the new debug save restore
     * @return modified instance
     */
     ...
     * 
     * @param b the new rkg use fairness
     * @return modified instance
     */
    ...
    /**
     * @param nSkipBeforeBlock number of nodes to skip
     */
     ...
     * 
     * @param b the new fpp debug split modules
     * @return modified instance
     */
     ...
     * 
     * @param o the new regular log output stream
     * @return modified instance
     */
     ...
     * 
     * @param o the new absorption log output stream
     * @return modified instance
     */
    ...
    static class LogAdapterStream implements LogAdapter, Serializable {
        ...
        @Override
        public LogAdapter print(Object s1, @Nullable Object s2) {
     ...
     * 
     * @param useELReasoner the new use el reasoner
     * @return modified instance
     */
     ...
     * 
     * @param useUndefinedNames the new use undefined names
     * @return modified instance
     */
     ...
     * 
     * @param useAxiomSplitting the new use axiom splitting
     * @return modified instance
     */
     ...
     * 
     * @param value the new rkg use ad in module extraction
     * @return modified instance
     */
     ...
     * 
     * @param useIncrementalReasoning the new use incremental reasoning
     * @return modified instance
     */
