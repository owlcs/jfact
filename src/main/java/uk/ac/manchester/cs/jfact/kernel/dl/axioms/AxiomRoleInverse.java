...
public class AxiomRoleInverse extends AxiomSingleORole {
    ...
    @PortedFrom(file = "tDLAxiom.h", name = "InvRole") private final ObjectRoleExpression inverseRole;
     ...
     *        invRole
     */
    public AxiomRoleInverse(OWLAxiom ax, ObjectRoleExpression dirRole, ObjectRoleExpression invRole) {
        super(ax, dirRole);
        inverseRole = invRole;
    }
