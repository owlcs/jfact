...
public class GeneratedJUnitTest_uk_ac_manchester_cs_jfact_kernel_state {
    ...
    public void shouldTestDLCompletionGraphSaveState() throws Exception {
        ...
        testSubject0.setnNodes(mock(int.class));
        testSubject0.setsNodes(mock(int.class));
        testSubject0.setnEdges(mock(int.class));
    ...
    public void shouldTestDLCompletionTreeSaveState() throws Exception {
        ...
        testSubject0.setCurLevel(mock(int.class));
        testSubject0.setnNeighbours(mock(int.class));
    ...
    public void shouldTestSaveList() throws Exception {
        ...
        DLCompletionTreeSaveState result1 = testSubject0.pop(mock(int.class));
        Object result2 = testSubject0.pop();
        boolean result3 = testSubject0.add(mock(DLCompletionTreeSaveState.class));
        testSubject0.add(mock(int.class), mock(DLCompletionTreeSaveState.class));
        Object result4 = testSubject0.get(mock(int.class));
        ...
        boolean result10 = testSubject0.addAll(mock(int.class), mock(Collection.class));
        ...
        Object result14 = testSubject0.remove(mock(int.class));
        boolean result15 = testSubject0.remove(mock(Object.class));
        Object result16 = testSubject0.remove();
        Object result17 = testSubject0.set(mock(int.class),
                mock(DLCompletionTreeSaveState.class));
        Object result18 = testSubject0.poll();
        ListIterator result19 = testSubject0.listIterator(mock(int.class));
        ...
        List result38 = testSubject0.subList(mock(int.class), mock(int.class));
    ...
    public void shouldTestSaveState() throws Exception {
        ...
        testSubject0.setSc(mock(int.class));
        testSubject0.setCc(mock(int.class));
