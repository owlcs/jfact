...
public class rdfbased_sem_eqdis_disprop_irrflxv {
    @Test
    public void testrdfbased_sem_eqdis_disprop_irrflxv() {
        ...
        String premise = "<rdf:RDF\n"
                ...
                + "    <owl:equivalentProperty rdf:resource=\"http://www.example.org#p\"/>\n"
                + "  </rdf:Description>\n"
                + "  <rdf:Description rdf:about=\"http://www.example.org#p\">\n"
                + "    <owl:propertyDisjointWith rdf:resource=\"http://www.example.org#q\"/>\n"
                + "  </rdf:Description>\n" + "</rdf:RDF>";
        String conclusion = "";
