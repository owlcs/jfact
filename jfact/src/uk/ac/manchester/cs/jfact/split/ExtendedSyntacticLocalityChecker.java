...
abstract class CardinalityEvaluatorBase extends SigAccessor 
 {
  ...
  // visitor helpers
     protected boolean isBotEquivalent ( Expression expr ) { return getUpperBoundDirect(expr) == 0; }
     protected boolean isTopEquivalent ( Expression expr ) { return getUpperBoundComplement(expr) == 0; }
     ...
     protected abstract int getExactValue ( int m, RoleExpression R, Expression C ) ;
         ...
         /// init c'tor
public     CardinalityEvaluatorBase ( TSignature s ) { super(s); value=0; }
...
public int getUpperBoundDirect ( Expression expr ) { return _getUpperBoundDirect(expr); }
         /// implementation of evaluation
public int getUpperBoundComplement ( Expression expr ) { return _getUpperBoundComplement(expr); }
         /// implementation of evaluation
public int getLowerBoundDirect ( Expression expr ) { return _getLowerBoundDirect(expr); }
         /// implementation of evaluation
public int getLowerBoundComplement ( Expression expr ) { return _getLowerBoundComplement(expr); }

/// implementation of evaluation
private int
 _getUpperBoundDirect ( Expression expr ) { return UBD.getValue(expr); }
/// implementation of evaluation
private int
 _getUpperBoundComplement ( Expression expr ) { return UBD.getValue(expr); }
/// implementation of evaluation
private int
_getLowerBoundDirect ( Expression expr ) { return LBD.getValue(expr); }
/// implementation of evaluation
private int
 _getLowerBoundComplement ( Expression expr ) { return LBC.getValue(expr); }
...
public  void visit ( ConceptObjectExists expr )
 ...
 class UpperBoundDirectEvaluator extends CardinalityEvaluatorBase
 {
     ...
     protected    int getNoneValue () { return -1; }
         /// define a special value for concepts that are in C^{<= n} for all n
     protected int getAllValue () { return 0; }
     ...
     protected int getEntityValue ( NamedEntity entity )
 {
     ...
     public    UpperBoundDirectEvaluator ( TSignature s ) { super(s) ;}

     // concept expressions
     public void visit ( ConceptTop c) { value = getNoneValue(); }
     public void visit ( ConceptBottom c) { value = getAllValue(); }
     public void visit ( ConceptNot expr ) { value = getUpperBoundComplement(expr.getConcept()); }
     public void visit ( ConceptAnd expr ) { value = getAndValue(expr); }
     public void visit ( ConceptOr expr ) { value = getOrValue(expr); }
     public void visit ( ConceptOneOf expr ) { value = expr.size(); }
     public void visit ( ConceptObjectSelf expr ) { value = isBotEquivalent(expr.getOR()) ? getAllValue() : getNoneValue(); }
     public void visit ( ConceptObjectValue expr ) { value = isBotEquivalent(expr.getOR()) ? getAllValue() : getNoneValue(); }
    ...
    public void visit(ConceptDataValue expr) {
     ...
     // object role expressions
     public void visit ( ObjectRoleTop c) { value = getNoneValue(); }
     public void visit ( ObjectRoleBottom c) { value = getAllValue(); }
     public void visit ( ObjectRoleInverse expr ) { value = getUpperBoundDirect(expr.getOR()); }
     ...
     // data role expressions
     public void visit ( DataRoleTop c) { value = getNoneValue(); }
     public void visit ( DataRoleBottom c) { value = getAllValue(); }

     // data expressions
     public void visit ( DataTop c) { value = getNoneValue(); }
     public void visit ( DataBottom c) { value = getAllValue(); }
     // FIXME!! not ready
     //public void visit ( DataTypeName ) { isBotEq = false; }
     // FIXME!! not ready
     //public void visit ( DataTypeRestriction ) { isBotEq = false; }
     public void visit ( Literal c) { value = 1; }
     public void visit ( DataNot expr ) { value = getUpperBoundComplement(expr.getExpr()); }
     public void visit ( DataAnd expr ) { value = getAndValue(expr); }
     public void visit ( DataOr expr ) { value = getOrValue(expr); }
     public void visit ( DataOneOf expr ) { value = expr.size(); }
     ...
     protected     int getEntityValue ( NamedEntity entity )
 {
     ...
     protected <C extends Expression>    int getOrValue ( NAryExpression<C> expr )
     {
         ...
         /// init c'tor
    public UpperBoundComplementEvaluator ( TSignature s ) { super(s) ;}

     // concept expressions
     public void visit ( ConceptTop c) { value = getAllValue(); }
     public void visit ( ConceptBottom c) { value = getNoneValue(); }
     public void visit ( ConceptNot expr ) { value = getUpperBoundDirect(expr.getConcept()); }
     public void visit ( ConceptAnd expr ) { value = getAndValue(expr); }
     public void visit ( ConceptOr expr ) { value = getOrValue(expr); }
     public void visit ( ConceptOneOf c) { value = getNoneValue(); }
     public void visit ( ConceptObjectSelf expr ) { value = isTopEquivalent(expr.getOR()) ? getAllValue() : getNoneValue(); }
     public void visit ( ConceptObjectValue expr ) { value = isTopEquivalent(expr.getOR()) ? getAllValue() : getNoneValue(); }
    ...
    public void visit(ConceptDataValue expr) {
     ...
     // object role expressions
     public void visit ( ObjectRoleTop c) { value = getAllValue(); }
     public void visit ( ObjectRoleBottom c) { value = getNoneValue(); }
     public void visit ( ObjectRoleInverse expr ) { value = getUpperBoundComplement(expr.getOR()); }
     public void visit ( ObjectRoleChain expr )
     {
         for ( ObjectRoleExpression p : expr.getArguments() ) {
     ...
     // data role expressions
     public void visit ( DataRoleTop c) { value = getAllValue(); }
     public void visit ( DataRoleBottom c) { value = getNoneValue(); }

     // data expressions
     public void visit ( DataTop c) { value = getAllValue(); }
     public void visit ( DataBottom c) { value = getNoneValue(); }
     // negated datatype is a union of all other DTs that are infinite
     public void visit ( Datatype c) { value = getNoneValue(); }
     // negated restriction include negated DT
     public void visit ( DatatypeExpression c) { value = getNoneValue(); }
     public void visit ( Literal c) { value = getNoneValue(); }
     public void visit ( DataNot expr ) { value = getUpperBoundDirect(expr.getExpr()); }
     public void visit ( DataAnd expr ) { value = getAndValue(expr); }
     public void visit ( DataOr expr ) { value = getOrValue(expr); }
     public void visit ( DataOneOf c) { value = getNoneValue(); }
 ...
 class LowerBoundDirectEvaluator extends CardinalityEvaluatorBase
 {
         ...
         /// define a special value for concepts that are not in C^{>= n}
     protected     int getNoneValue () { return 0; }
         /// define a special value for concepts that are in C^{>= n} for all n
     protected    int getAllValue () { return -1; }
...
//                   return getNoneValue();
     ...
     protected <C extends Expression>    int getOrValue ( NAryExpression<C> expr )
     {
         ...
         /// init c'tor
public  LowerBoundDirectEvaluator ( TSignature s ) {super(s) ;}

     // concept expressions
     public void visit ( ConceptTop c) { value = 1; }
     public void visit ( ConceptBottom c) { value = getNoneValue(); }
     public void visit ( ConceptNot expr ) { value = getLowerBoundComplement(expr.getConcept()); }
     public void visit ( ConceptAnd expr ) { value = getAndValue(expr); }
     public void visit ( ConceptOr expr ) { value = getOrValue(expr); }
     public void visit ( ConceptOneOf expr ) { value = expr.size() > 0 ? 1 : getNoneValue(); }
     public void visit ( ConceptObjectSelf expr ) { value = isTopEquivalent(expr.getOR()) ? 1 : getNoneValue(); }
     // FIXME!! differ from the paper
     public void visit ( ConceptObjectValue expr ) { value = isTopEquivalent(expr.getOR()) ? 1 : getNoneValue(); }
    ...
    public void visit(ConceptDataValue expr) {
     ...
     public void visit ( ObjectRoleTop c) { value = getAllValue(); }
     public void visit ( ObjectRoleBottom c) { value = getNoneValue(); }
     public void visit ( ObjectRoleInverse expr ) { value = getLowerBoundDirect(expr.getOR()); }
     public void visit ( ObjectRoleChain expr )
     {
         for ( ObjectRoleExpression p : expr.getArguments() ) {
            if ( !isTopEquivalent(p) )
     ...
     public void visit ( DatatypeExpression c) { value = getNoneValue(); }
     public void visit ( Literal c) { value = getNoneValue(); }
     public void visit ( DataNot expr ) { value = getLowerBoundComplement(expr.getExpr()); }
     public void visit ( DataAnd expr ) { value = getAndValue(expr); }
     public void visit ( DataOr expr ) { value = getOrValue(expr); }
     public void visit ( DataOneOf expr ) { value = expr.size() > 0 ? 1 : getNoneValue(); }
 }
...
//                   return getNoneValue();
         ...
         /// init c'tor
 public    LowerBoundComplementEvaluator ( TSignature s ) {super(s) ;}

     // concept expressions
     public void visit ( ConceptTop c ) { value = getNoneValue(); }
     public void visit ( ConceptBottom c ) { value = 1; }
     public void visit ( ConceptNot expr ) { value = getLowerBoundDirect(expr.getConcept()); }
     public void visit ( ConceptAnd expr ) { value = getAndValue(expr); }
     public void visit ( ConceptOr expr ) { value = getOrValue(expr); }
     public void visit ( ConceptOneOf c) { value = getNoneValue(); }
     public void visit ( ConceptObjectSelf expr ) { value = isBotEquivalent(expr.getOR()) ? 1 : getNoneValue(); }
     public void visit ( ConceptObjectValue expr ) { value = isBotEquivalent(expr.getOR()) ? 1 : getNoneValue(); }
    ...
    public void visit(ConceptDataValue expr) {
     ...
     public void visit ( ObjectRoleTop c) { value = getNoneValue(); }
     public void visit ( ObjectRoleBottom c) { value = getAllValue(); }
     public void visit ( ObjectRoleInverse expr ) { value = getLowerBoundComplement(expr.getOR()); }
     public void visit ( ObjectRoleChain expr )
     {
         for ( ObjectRoleExpression p : expr.getArguments() ) {
            if ( isBotEquivalent(p) )
     ...
     //public void visit ( DataTypeRestriction ) { isBotEq = false; }
     public void visit ( Literal c) { value = 1; }
     public void visit ( DataNot expr ) { value = getLowerBoundDirect(expr.getExpr()); }
     public void visit ( DataAnd expr ) { value = getAndValue(expr); }
     public void visit ( DataOr expr ) { value = getOrValue(expr); }
     public void visit ( DataOneOf c) { value = getNoneValue(); }
 }
 ...
 public class ExtendedSyntacticLocalityChecker extends GeneralSyntacticLocalityChecker
 {
     ...
     protected      boolean isTopEquivalent ( Expression expr ) { return UBC.getUpperBoundComplement(expr) == 0; }
         /// @return true iff EXPR is bottom equivalent
     protected boolean isBotEquivalent ( Expression expr ) { return UBD.getUpperBoundDirect(expr) == 0; }
         /// @return true iff role expression in equivalent to wrt locality
     protected boolean isREquivalent ( Expression expr ) { return topRLocal() ? isTopEquivalent(expr) : isBotEquivalent(expr); }
